...
- 누적합 기준으로 생각했을 때, 이번 x까지의 누적합에서 k를 뺀 f(x)-k가, 그 이전에 몇 번 나왔는가를 세야 함
- 최초에 맵에 (0, 1)을 넣어줘야 함.
- [참고](https://nahwasa.com/entry/%EC%9E%90%EB%B0%94-%EB%B0%B1%EC%A4%80-2015-%EC%88%98%EB%93%A4%EC%9D%98-%ED%95%A9-4-java)
